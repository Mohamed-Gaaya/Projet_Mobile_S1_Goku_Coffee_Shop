...
public class  CartFragment extends Fragment {
    ...
    Button orderbutton;
    TextView orderSummary, quantityOnfAB;
    ...
    public void onViewCreated(View view,  Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_cartFragment_to_profileActivity3);
            }
        });
        ...
        firestore.collection("Cart").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(QuerySnapshot value,  FirebaseFirestoreException error) {
                ...
                if (value!=null) {
                    ...
                    orderSummary.setText("Total = "  +String.valueOf(totalOrderCost)+" DT");
                    totalOrderCost = 0;
                    saveTotalCost.clear();
