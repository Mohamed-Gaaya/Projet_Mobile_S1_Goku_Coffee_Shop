...
public class CoffeeDetailFragment extends Fragment {
    ...
    TextView coffeename, description, quantityview, orderINFO, quantityOnfAB;
    ImageView imageView, home, profile, orderr;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        coffeename.setText(name + String.valueOf(price)+  " DT" );
...
//        fetching the recent quantity in firestore and displaying it
        firebaseFirestore.collection("Coffies").document(coffeeid).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(DocumentSnapshot value,  FirebaseFirestoreException error) {
                ...
                orderINFO.setText(String.valueOf("Total Price = " + totalPrice)+" DT");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 10) {
                    ...
                    // showing the price
                    totalPrice = quantity * price;
                    orderINFO.setText(String.valueOf("Total Price = " + totalPrice));
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (quantity == 0) {
                    ...
                    Toast.makeText(getContext(), "You've added  " + quantity + name, Toast.LENGTH_SHORT).show();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_coffeeDetailFragment_to_cartFragment);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_coffeeDetailFragment_to_profileActivity);
